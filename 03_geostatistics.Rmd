...
```{r load-rongelap-data, message=FALSE, results='hide'}
# load the point data
...
```{r load-meuse-data, message=FALSE, results='hide'}
# load the meuse data
...
```{r meuse-kriging, message=FALSE, results='hide'}
